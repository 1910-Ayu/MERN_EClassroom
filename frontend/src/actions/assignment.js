  ...
  return async (dispatch, getState) => {
    try {
      ...
      const { data: pendingQuizzes } = await axios.get(
        `/api/quiz/fetch/pending/${classId}`,
        config
      );
      const { data: pendingAssignments } = await axios.get(
        `/api/assignment/fetch/pending/${classId}`,
        config
      );
      dispatch({
...
export const fetchQuiz = (quizId) => {
  return async (dispatch, getState) => {
    try {
      ...
      const { data } = await axios.get(`/api/quiz/fetch/${quizId}`, config);
      dispatch({
...
export const submitQuiz = (quizId, submission) => {
  return async (dispatch, getState) => {
    try {
      ...
      await axios.post("/api/quiz/submit", postData, config);
...
export const fetchUsersQuizSubmission = (quizId, userId) => {
  return async (dispatch, getState) => {
    try {
      ...
      const { data } = await axios.get(
        `/api/quiz/submission/?quizId=${quizId}&userId=${userId}`,
        config
      );
...
export const fetchUsersAssignmentSubmission = (assignmentId, userId) => {
  return async (dispatch, getState) => {
    try {
      ...
      const { data } = await axios.get(
        `/api/assignment/submission/?assignmentId=${assignmentId}&userId=${userId}`,
        config
      );
...
export const fetchAssignment = (assignmentId) => {
  return async (dispatch, getState) => {
    try {
      ...
      const { data } = await axios.get(
        `/api/assignment/fetch/${assignmentId}`,
        config
      );
...
export const createAssignment = (formData) => {
  return async (dispatch, getState) => {
    try {
      ...
      await axios.post("/api/assignment/create", formData, config);
...
export const uploadAssignmentSubmission = (formData) => {
  return async (dispatch, getState) => {
    try {
      ...
      await axios.post("/api/assignment/submit", formData, config);
...
export const downloadAssignment = (assignmentId) => {
  return async (dispatch, getState) => {
    try {
      ...
      const { data } = await axios.get(
        `/api/assignment/getFileExtension/${assignmentId}`,
        config
      );
      const res = await axios.get(
        `/api/assignment/download/${assignmentId}`,
        {
          headers: {
            Authorization: `Bearer ${userInfo.data.token}`,
          },
...
export const downloadAssignmentSubmission = (assignmentId, userId) => {
  return async (dispatch, getState) => {
    try {
      ...
      const { data } = await axios.get(
        `/api/assignment/submission/getFileExtension/${assignmentId}?${
          userId && `userId=${userId}`
        }`,
        config
      );
      const res = await axios.get(
        `/api/assignment/submission/download/${assignmentId}?${
          userId && `userId=${userId}`
        }`,
        {
          headers: {
